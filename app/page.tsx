...
const FEATURES = [
  {
    ...
    desc: "Block phishing, malware, spoofing & anomalies in real-time.",
    icon: ShieldCheck,
  },
  {
    title: "Quarantine & Review",
    desc: "Auto-quarantine with audit trail & one-click release.",
    icon: CheckCircle2,
  },
  {
    title: "Live Inbox Monitoring",
    desc: "Gmail & Outlook integrations with least-privilege scopes.",
    icon: Bell,
  },
  {
    title: "Encryption & 2FA",
    desc: "Admin dashboard secured with encryption and two-factor auth.",
    icon: Lock,
  },
];
...
const PRICING = [
  {
    ...
    features: [
      "Up to 25 mailboxes",
      "AI phishing & malware detection",
      "Basic quarantine & alerts",
    ],
  },
  {
    name: "Pro",
    ...
    <div className="min-h-screen w-full bg-slate-900 text-white">
      ...
      <section id="home" className="relative overflow-hidden">
        <div className="absolute inset-0 -z-10" aria-hidden>
          ...
          />
          <div
            className="absolute -bottom-24 -left-24 w-[40rem] h-[40rem] rounded-full blur-3xl opacity-20"
        ...
        <div className="max-w-7xl mx-auto px-4 py-24 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="mt-4 text-lg text-gray-300">
              Stop phishing and business email compromise before it reaches your
              team. Fast setup, transparent controls, and protection that learns
              from every threat.
            </p>
            ...
            {PRICING.map((p, i) => (
              <motion.div
                ...
                className={`rounded-3xl border ${
                  i === 1 ? "border-slate-400" : "border-slate-700"
                } bg-slate-900 p-6 shadow flex flex-col`}
              >
        ...
        <div className="max-w-7xl mx-auto px-4 py-20 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-300">
              {BRAND.name} helps SMBs block phishing, malware, and impersonation
              with AI. Deploy in minutes, keep control with clear quarantine
              workflows, and meet security best practices without an enterprise
              price tag.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 py-20 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-3 text-gray-300">
              Tell us about your email environment and we’ll schedule a guided
              walkthrough.
            </p>
          ...
          <form
            className="bg-slate-800 text-white rounded-3xl p-6 shadow space-y-4"
            method="POST"
            action="/api/contact"
          >
            <div>
